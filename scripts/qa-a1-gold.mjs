...
must(runtime.includes("id:'su-a1-l1'")&&runtime.includes("ready:true"),'A1 Lesson 1 must be enabled');
...
must(server.includes('LISTENING_SCRIPTS["su-a1-l1"]'),'A1 Lesson 1 listening source missing');

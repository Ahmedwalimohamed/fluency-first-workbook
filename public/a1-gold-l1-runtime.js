...
const BATCH_A={
 ...
 'a1-gold-l18':{title:'Global Connections',mission:'Exchange an international profile and adapt',instruction:'Introduce yourself, exchange country/language/place information, ask at least two useful questions, then respond when the meeting place changes.',minDetails:5,minQuestions:2},
 'a1-gold-l19':{title:'Shopping & Services',mission:'Complete a service transaction',instruction:'Ask about product, price, size or colour, adapt when the first option is unavailable, pay, and request a receipt using at least three useful questions.',minDetails:5,minQuestions:3},
 'a1-gold-l20':{title:'Home & Daily Life',mission:'Help a visitor with home and routine information',instruction:'Describe rooms and routine times, answer a practical visitor question, and update one changed time.',minDetails:5,minQuestions:1},
 'a1-gold-l21':{title:'Plans & Events',mission:'Arrange and repair a plan',instruction:'Compare availability, propose a time and place, ask at least two questions, then make a new plan after the event time changes.',minDetails:5,minQuestions:2},
 'a1-gold-l22':{title:'My English in the Real World',mission:'Complete the independent A1 real-world mission',instruction:'Start the exchange, introduce yourself, find place and time, solve one service problem, ask at least two useful questions, make a next arrangement, and adapt to a changed detail.',minDetails:6,minQuestions:2}
};

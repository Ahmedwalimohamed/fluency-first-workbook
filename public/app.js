  ...
  <div class="eg-premium-dashboard">
   ...
   <aside class="eg-premium-side">
    <div class="eg-premium-quick-actions">
     ...
     <button class="eg-premium-action" id="viewCourseBtn" type="button"><span class="eg-action-icon" aria-hidden="true">▧</span><strong>Workbook</strong><b aria-hidden="true">›</b></button>
    </div>

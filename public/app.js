...
function workbookEvidenceCell(sid,lid,skill){
 ...
 if(!e.completed&&!e.latest)return '<div class="report-work-cell is-not-started"><strong>Not started</strong><small>No saved workbook work</small></div>';
 ...
 return `<div class="report-work-cell ${e.completed?'is-complete':'is-attempted'}"><div>${score}<span class="report-work-state">${state}</span></div><small>${attemptsText}</small></div>`
}

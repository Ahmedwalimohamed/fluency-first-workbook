...
function setStudentPronunciationMode(on){
 ...
 if(btn){btn.classList.toggle('active',studentPronunciationMode);btn.setAttribute('aria-pressed',studentPronunciationMode?'true':'false');btn.innerHTML=studentPronunciationMode?'🔊 Pronunciation on':'🔊 Pronunciation'}

  ...
  <div class="eg-writing-layout eg-writing-layout-designed">
   <main class="eg-writing-workspace">
    ...
    <article class="guided-question writing-guided-question final-writing-card eg-message-composer">
     ...
     <div class="writing-publish-note"><strong>My Writings</strong><span>Your final writing will appear in the learner writing community after you save it. Only you can share your writing outside EnglishGate.</span></div><div class="writing-task-head"><div><span class="stage-badge">${teacherView?'Part 2 · Write it yourself':'Your writing task'}</span><strong>${escapeHtml(spec.task)}</strong></div><span>${spec.min}–${spec.max} words</span></div>

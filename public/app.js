...
function makeBlueprintB2Lesson(x){return{id:x.id,number:x.number,title:x.title,outcome:x.outcome,ready:true,targetVocabulary:x.vocabulary,vocabulary:{items:x.vocabularyItems},listening:{title:x.title+' · Reading & Listening',readingText:x.readingText,audioScript:x.audioScript,text:x.audioScript,questions:x.questions},grammar:{focus:x.grammarFocus,rule:x.grammarRule,items:grammarQuestions(x.grammarFocus)},writing:x.writing}}
